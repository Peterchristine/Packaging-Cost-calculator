    ...
    public void calculateCost(){
       ...
       // cost.setOnAction(e->{
                ...
                cost.setStyle("-fx-text-fill: black; -fx-font: normal 19px 'serif';");
                 ...
                 showText.setText("Requested "+quantity+" box(es) of L "+l+" W "+w+" H "+h+" Grade "+cGrade+" Color Print  "+cPrint+" Reinforce "+Breinforced+" and "+Creinforced+" Sealable Top "+sealTop);
                 
                }
                //System.out.println(cGrade+"\n"+cPrint+"\n"+sealTop+"\n"+w+"\n"+Creinforced+" hello ther");
